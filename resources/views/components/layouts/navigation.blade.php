                    ...
                    <div class="flex space-x-4">
                        ...
                        @auth
                            <form action="{{ route('logout') }}" method="post">
                                @csrf
                                <button type="submit"
                                        class="lg:px-3 py-2 text-sm font-medium rounded-md hover:text-sky-600 dark:hover:text-white {{ request()->routeIs('logout')? 'text-sky-600 dark:text-white' : 'text-slate-400' }}">
                                    Logout
                                </button>
                            </form>
                        @endauth
